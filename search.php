...
?>
				...
				<h4 class="h3_title">Search Results </h4>
					...
					<?php //include_once"includes/list_horizontal.php"; ?>
                            ...
                            if(isset($_GET['submit_search'])){
                                ...
                                $get_cat = "select * from items where features  like '%$query_name%' 
                                            OR price like '%$query_name%' OR details like '%$query_name%' 
                                            OR type like '%$query_name%' OR features like '%$query_name%'
                                            OR location like '%$query_name%'";
			...
			<div class="banner-bottom-video-grid-rgt" style="margin:10px 4px;">
						...
						<div class="caption">
							...
							<div class="more m1 pull-left">
								<a href="single.php">View Details</a>
							</div>
