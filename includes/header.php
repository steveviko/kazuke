...
.banner1 {
  background: url(../images/f5.jpg) no-repeat 0px 0px;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
.search form input[type="submit"] {
  background: url(../images/search.png) no-repeat 9px 5px;
  width: 45px;
  height: 32px;
  border: none;
  margin: 0 0 0 -4px;
...
/*-- banner-slider --*/
.banner-slider {
  background: url(../images/f4.jpg) no-repeat 0px 0px;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
.gallery1 .textbox {
  ...
  transform: scale(0);
  background-color: rgba(3, 81, 148, 0.85);
  border-radius: 50%;
  -webkit-border-radius: 50%;
  -moz-border-radius: 50%;
  -o-border-radius: 50%;
